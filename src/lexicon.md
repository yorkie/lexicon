<dl url="https://EcmaTC53.github.io/lexicon">ECMA TC-53 Terms
  ...
  <dt><h4><a href="https://gist.github.com/phoddie/166c9c17b2f31d0beda9f2410a219268">I/O Class Pattern</a> (IOCP)</h4>
  ...
  <dt><h4><a href="https://developer.mozilla.org/en-US/docs/Glossary/JSON">Javascript Object Notation (JSON)</a></h4>
  <dd>A data-interchange format that closely resembles a subset of JavaScript syntax.
  <dt><h4>Job</h4>
  <dd>A task to be executed asynchronously.
  <dt><h4><a href="https://blog.senr.io/blog/jtag-explained">JTAG</a></h4>
  ...
  <dt><h4><a href="https://developer.mozilla.org/en-US/docs/Glossary/Method">Method</a></h4>
  <dd>A function which is a property of an object.
  <dt><h4>Microcontroller (MCU)</h4>
  <dd>A Microcontroller is a single integrated circuit with one or more CPUs, memory and programmable input/output.
  <dt><h4><a href="https://developer.mozilla.org/en-US/docs/Glossary/Mixin">Mixin</a></h4>
  ...
  <dt><h4><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/import">Module</a></h4>
  <dd>Ecmascript code stored in an external file and imported via the ES6 import statement.
  <dt><h4><a href="https://developer.mozilla.org/en-US/docs/Glossary/Mutable">Mutable</a></h4>
  <dd>A variable that can be changed.
  <dt><h4>Native bindings</h4>
  <dd>Native bindings allow Ecmascript to call native code.
  <dt><h4>Non-blocking</h4>
  <dd>Code that does not block execution.
  <dt><h4><a href="https://developer.mozilla.org/en-US/docs/Glossary/Normative">Normative</a></h4>
  <dd>Things that have been standardized and must be followed as a rule.
  <dt><h4><a href="https://developer.mozilla.org/en-US/docs/Glossary/Parameter">Parameter</a></h4>
  <dd>A named variable passed into a function.
  <dt><h4>Partial Evaluation</h4>
  ...
  <dt><h4>Pull up/Pull down resisitor</h4>
  ...
  <dt><h4>Pulse Width Modulation (PWM)</h4>
  ...
  <dt><h4>Self Hosted</h4>
  <dd>~~~ Need help with this from tc53-2018-019 (Boston meeting) ~~~
  <dt><h4><a href="https://github.com/Agoric/SES">Secure EcmaScript</a></h4>
  ...
  <dt><h4>Serial Peripheral Interface (SPI)</h4>
